...
const TaskEfficiency = ({ details }) => {
  const { estimatedHours, actualHours, taskEfficiencyIndexPercentage } = details
        ...
        >
          <Grid xs={12} display='flex'>
            <Grid item xs={7}>
              ...
              /> */}
              <ReactApexcharts type='radialBar' height={150} options={options} series={[Math.trunc(taskEfficiencyIndexPercentage)]} />
            </Grid>
